...
\usepackage[backend=biber, style=authoryear, natbib=true, hyperref=true, isbn = false, url = false, doi = false, maxparens = 5, maxbibnames = 50, maxcitenames = 1, useprefix = true, block = space]{biblatex}
