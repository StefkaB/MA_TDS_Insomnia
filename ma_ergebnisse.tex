...
Gegenüberstellung von \texttt{nmean} und Alter, vgl. Anhang Abb. \ref{fig:nmean_age_siesta}



\begin{figure}[H]
	\centering
	\includegraphics[width = \textwidth]{img/dsls_young_old.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = \textwidth]{img/rw_young_old.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = \textwidth]{img/dsls_m_f.png}
	\caption[Verbindungsstärken von weiblichen und männlichen Insomniepatienten]{Gemittelte Verbindungsstärken von weiblichen und männlichen Insomniepatienten im Tiefschlaf (links) und Leichtschlaf (rechts);\\unteres linkes Dreieck: männliche Insomniepatienten;\\oberes rechtes Dreieck: weibliche Insomniepatienten}
	\label{fig:dsls_m_f}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = \textwidth]{img/rw_m_f.png}
	\caption[Verbindungsstärken von weiblichen und männlichen Insomniepatienten]{Gemittelte Verbindungsstärken von weiblichen und männlichen Insomniepatienten im REM-Schlaf (links) und Wachzustand (rechts);\\unteres linkes Dreieck: männliche Insomniepatienten;\\oberes rechtes Dreieck: weibliche Insomniepatienten}
	\label{fig:rw_m_f}
\end{figure}
