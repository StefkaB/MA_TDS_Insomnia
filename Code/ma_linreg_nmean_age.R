...
# link strength (nmean) and age of all patients, all female and all male and
# for each sleep stage

############### Metadaata ################
# Stefanie Breuer, 22.03.2017, 
...
# add linear regression lines of whole data, female and male data
...
cor.test(nmean_m_w, age_m, method="spearman")
