...
ticks = [0.5,4.5,8.5,13.5,18.5,23.5,28.5,33.5,38.5];
borders = [0,39];
...
for stage = 1:4
    ...
    for m = 1:length(eeglabels)
        t_lb = text(ticks(m+2)+2,40,eeglabels{m});
        if (mplot)
            set(t_lb,'Fontsize',5)
        end
    ...
    set(iha,'ytick',[0.5,4.5,8.5,13.5,18.5,23.5,28.5,33.5,38.5]);
    set(iha,'yticklabel','    ');
    set(iha,'xtick',[0.5,4.5,8.5,13.5,18.5,23.5,28.5,33.5,38.5]);
    set(iha,'xticklabel','');
