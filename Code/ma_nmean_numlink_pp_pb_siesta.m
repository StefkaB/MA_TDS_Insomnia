...
% periphery-periphery and periphery-brain subnetworks for matches from
% siesta data (set see master thesis of Stefanie Breuer for classification
% of matches)
%
%% Metadata
